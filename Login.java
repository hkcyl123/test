...
//        pn1_south.add(label3);
        ...
        pn2.add(pn2_center);
        pn2.add(pn2_south);
        JLabel label4 = new JLabel("<html><font color=#CC00FF size='7'><i>欢迎"
                + "登陆</i></font>", SwingConstants.CENTER);
        cp.add(label4, "North");
        cp.add(pn1, "Center");
        cp.add(pn2, "South");
...
//            userAdd.setVisible(true);
    ...
    public void confirm()//验证用户和密码是否正确
    {
        ...
        try{
            ...
            String query = "select * from administrator where MID='"
                    + uname + "' and Mpsw ='" + passwd + "'";
